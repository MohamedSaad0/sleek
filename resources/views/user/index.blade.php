{{-- @foreach ($products as $product)
    ...
    @php
    $vegeCats = array($prod);
     $vegeCat = array_filter($vegeCats, function($pro){
        return $pro->name == "Vegetables";
         });
    @endphp
        @dd($vegeCat);
        @dd($prod->name);
                ...
                <div class="col-md-12 col-lg-5">
                    <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            ...
                            alt="First slide"> --}}
                                <img src="{{ URL::to('public/images/front-end/hero-img-1.png ') }}"
                                    class="img-fluid w-100 h-100 bg-secondary rounded" alt="First slide">
                                <a href="#" class="btn px-4 py-2 text-white rounded">Fruites</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="{{ URL::to('public/images/front-end/hero-img-2.jpg') }}"
        ...
        <div class="container py-5">
            <div class="tab-class text-center">
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            ...
                            <li class="nav-item">
                                <a class="d-flex py-2 m-2 bg-light rounded-pill" data-bs-toggle="pill" href="#veges">
                ...
                <div class="tab-content">
                                                ...
                                                <div class="fruite-img">
                                                    @foreach ($product->images as $image)
                                                        <img src="{{ URL::to('public/images/products/' . $image->image_path) }}"
                                                            alt="Fruit" class="img-fluid w-100 rounded-top">
                                                    @endforeach
                                                </div>
                    ...
                    <div id="veges" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-lg-12">
                                <div class="row g-4">
        ...
        <div class="container py-5">
            <div class="row g-4 justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        @foreach ($products->where('subcategory', 'Tasty')->take(1) as $product)
                            <div class="service-item bg-secondary rounded border border-secondary">
                                @foreach ($product->images as $image)
                                    <img src="{{ URL::to('public/images/products/' . $image->image_path) }}"
                                        class="img-fluid rounded-top w-100" alt="Chicken-Curry-Cut">
                                @endforeach
                                <div class="px-4 rounded-bottom">
                                    <div class="service-content bg-primary text-center p-4 rounded">
                                        <h5 class="text-white">{{ $product->subcategory }}</h5>
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        @foreach ($products->where('subcategory', 'Fresh Organic Vegetables')->take(1) as $product)
                            <div class="service-item bg-secondary rounded border border-secondary">
                                @foreach ($product->images as $image)
                                    <img src="{{ URL::to('public/images/products/' . $image->image_path) }}"
                                        class="img-fluid rounded-top w-100" alt="Chicken-Curry-Cut">
                ...
                <div class="col-md-6 col-lg-4">
                    <a href="#">
                        @foreach ($products->where('subcategory', 'Exotic Vegetables')->take(1) as $product)
                            <div class="service-item bg-secondary rounded border border-secondary">
                                @foreach ($product->images as $image)
                                    <img src="{{ URL::to('public/images/products/' . $image->image_path) }}"
                                        class="img-fluid rounded-top w-100" alt="Chicken-Curry-Cut">
    ...
    <div class="container-fluid vesitable py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel vegetable-carousel justify-content-center">
                @foreach ($products->where('subcategory', 'Fresh Organic Vegetables') as $product)
    ...
    <div class="container-fluid banner bg-secondary my-5">
        <div class="container py-5">
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    @foreach ($products->where('subcategory', 'Fresh Exotic Fruits') as $product)
                        <div class="py-4">
                            <h1 class="display-3 text-white">{{ $product->subcategory }}</h1>
                    ...
                    <div class="position-relative">
                        ...
                        <div class="d-flex align-items-center flex-nowrap">
                            ...
                            <div class="bg-secondary rounded">
                                ...
                                <img src="" class="img-fluid rounded" style="width: 100px; height: 100px;"
                                    alt="">
